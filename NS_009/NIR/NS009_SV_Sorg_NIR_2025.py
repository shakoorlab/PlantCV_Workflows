...
target_matrix = pcv.transform.load_matrix(filename='/shares/shakoor/users/jstanton/x-rite_color_matrix_k2.npz')
...
# color card import
color, path1, filename1 = pcv.readimage(filename='/shares/shakoor/users/jstanton/NIR/color_card.png')

# nir color card import
nir_color_card, path1, filename1 = pcv.readimage(filename='/shares/shakoor/users/jstanton/NIR/nir_card.png')
