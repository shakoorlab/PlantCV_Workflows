...
if obj_area_ab > 4:
    ...
    analysis_image = pcv.analyze_object(img=color_corrected_img, obj=obj_combined_ab, mask=thresh1_filled_holes, label="default")
    boundary_image = pcv.analyze_bound_horizontal(img=color_corrected_img, obj=obj_combined_ab, mask=thresh1_filled_holes, 
                                               line_position=1980, label="default")

# Determine color properties
    color_histogram = pcv.analyze_color(rgb_img=color_corrected_img, mask=thresh1_filled_holes, colorspaces='all', label="default")
